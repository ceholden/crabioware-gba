...
use agb::display::tiled::{AffineMap, MapLoan, RegularMap, Tiled0, Tiled1, TiledMap, VRamManager};
use agb::Gba;
    ...
    pub fn create<'g>(&self, gba: &'g mut Gba) -> (TiledModeResource<'g>, VRamManager) {
        ...
        match self {
            TiledMode::Mode0 => {
                ...
                (
                    TiledModeResource::Mode0(tiled0, unmanaged, sprite_loader),
                    vram,
                )
            }
            TiledMode::Mode1 => {
                ...
                (
                    TiledModeResource::Mode1(tiled1, unmanaged, sprite_loader),
                    vram,
                )
            }
        }
